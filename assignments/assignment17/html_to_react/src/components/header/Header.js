    ...
    <header>
      <div className="container">
        <nav className="navbar">
          <a href="#">
            <img src={require("../../assets/images/logo-light.svg")} alt="SimpleBlog logo" width="150" className="logo-light" />
            <img src={require("../../assets/images/logo-dark.svg")} alt="SimpleBlog logo" width="150" className="logo-dark" />
          </a>
